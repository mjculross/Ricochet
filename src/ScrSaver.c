...
void update_date(PblTm *current_time, bool move);
void update_display(PblTm *current_time, bool move);
void update_time(PblTm *current_time, bool move);
...
void update_display(PblTm *current_time, bool move)
{
   if (time_on_top)
   {
      update_date(current_time, move);
      update_time(current_time, move);
   }
   else
   {
      update_time(current_time, move);
